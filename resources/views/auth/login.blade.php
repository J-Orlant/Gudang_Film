                ...
                <div class="container rounded flex-column kartu py-5 px-5">
                    ...
                    <form action="">
                        <div class="form-group mb-3">
                            ...
                            <input type="email" class="col-lg-10 rounded inp">
                        </div>
                        <div class="form-group">
                            <label for="">Password</label><br>
                            <div class="pass">
                                <div class="input-group">
                                    <input type="password" class="col-lg-4 rounded-left inp">
                        ...
                        <div class="d-flex aling-items-center check">
                            <input type="checkbox">
                            <p class="col-lg-11 checkmessage">By creating an account, you agree to the Terms of Service and Conditions, and Privacy Policy</p>
                        </div>
                        <div class="mid d-flex flex-column align-items-center justify-content-center" style="width: 100%;">
                            <button class="col-md-6 btn btn-primary mb-2">Create Account</button>
                            <p class="text-center mb-2 txt">Already have an account?<a href="/">Login</a></p>
